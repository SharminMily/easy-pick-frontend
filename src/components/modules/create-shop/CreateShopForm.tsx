        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4 items-center">
              ...
              {/* <EPImageUploader setImageFiles={setImageFiles}
              ...
              {imagePreview.length > 0 ? (
                ...
                <div className="mt-8">
                  <EPImageUploader
                      setImageFiles={setImageFiles}
                      setImagePreview={setImagePreview}
                      label="Upload Logo" imageFiles={[]}                  />
                </div>
              )}
            </div>  
            <Button type="submit" className="mt-5 w-full bg-fuchsia-600 text-white hover:bg-fuchsia-800">
